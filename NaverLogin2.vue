...
export default {
  ...
  mounted() {
    this.naverLogin = new window.naver.LoginWithNaverId({
      clientId: "dOE3mjlgT_dOFfcbGK4W", //개발자센터에 등록된 클라이언트아이디
      callbackUrl: "http://localhost:8080/naverlogin2", // 개발자센터에 등록한 콜백유알엘
      isPopup: false,
  ...
  methods: {
    logout() {
      ...
      const url =
        "/oauth2.0/token?grant_type=delete&dOE3mjlgT_dOFfcbGK4W=jyvqXeaVOVmV&client_secret=e5FTvFLz2M&access_token=" +
        accessToken +
